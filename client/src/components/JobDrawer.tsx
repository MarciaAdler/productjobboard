          ...
          <>
            ...
            <div className="px-6 pt-5 pb-4 border-b border-slate-100">
              <div className="flex items-start gap-3">
                ...
                <button
                  onClick={onClose}
                  className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors"
                  aria-label="Close"
                >
            ...
            <div className="flex-1 overflow-y-auto">
              {job.companyDescription || job.requirements || job.descriptionText ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
                  ...
                  <p className="text-xs text-slate-600 mt-1">View the original posting for the full description.</p>
                </div>
              )}
            </div>
